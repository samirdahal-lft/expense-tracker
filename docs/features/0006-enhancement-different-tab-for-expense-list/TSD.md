...
> Story IDs are S-0006.nn — the 0006 prefix is what resolves this folder (docs/features/0006-*/),
> so the `## TSD S-0006.nn` header below must match the story ID exactly.
...
## TSD S-0006.01 — <title>  (PRD §S-0006.01)
| Aspect | Spec |
|--------|------|
