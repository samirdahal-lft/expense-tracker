...
- AC-2 [non-functional]: Single-page layout uses rounded card surfaces with subtle shadows, one consistent accent color, and a considered type/spacing scale. — coverage:
